...
!function(t) {
        ...
        if (-1 !== t.inArray(!1, n))
            ...
            if (0 !== c.length)
                ...
                u = u ? 0 : s; u < l; u++) {
                    ...
                    0 !== i) {
                        var p = o[r % i];
                        h._sRowStripe != p && (t(d).removeClass(h._sRowStripe).addClass(p),
                        h._sRowStripe = p)
                    }
    ...
    function B(e, n, a) {
        if (Nt(e, "aoServerParams", "serverParams", [n]),
        n && t.isArray(n)) {
            var r = {}
              , o = /(.*?)\[\]$/;
        ...
        e.fnServerData ? e.fnServerData.call(s, e.sAjaxSource, t.map(n, function(t, e) {
            ...
            url: l || e.sAjaxSource
        })) : t.isFunction(l) ? e.jqXHR = l.call(s, n, u, e) : (e.jqXHR = t.ajax(t.extend(c, l)),
        l.data = i)
    }
    function U(t) {
    ...
    function ht(e) {
        ...
        d = T.outerWidth(),
        "" === s ? (x.width = "100%",
        F && (T.find("tbody").height() > m.offsetHeight || "scroll" == v.css("overflow-y")) && (x.width = vt(T.outerWidth() - f)),
        d = T.outerWidth()) : "" !== u && (x.width = vt(u),
        d = T.outerWidth()),
        pt(N, r),
        pt(function(e) {
            j.push(e.innerHTML),
        ...
        t(o).height(0)),
        pt(function(t, e) {
            t.innerHTML = '<div class="dataTables_sizing" style="height:0;overflow:hidden;">' + j[e] + "</div>",
            t.style.width = R[e]
        }, r),
        I && pt(function(t, e) {
        ...
        T.outerWidth() < d ? (n = m.scrollHeight > m.offsetHeight || "scroll" == v.css("overflow-y") ? d + f : d,
    ...
    var Ut, Vt, Xt, Jt, qt = function(e) {
        ...
        return this.each(function() {
            ...
            if ("table" != this.nodeName.toLowerCase())
                ...
                p = [],
                0 !== (C = this.getElementsByTagName("thead")).length && (W(I.aoHeader, C[0]),
                p = E(I)),
                null === g.aoColumns)
                    for (C = [],
                    b = 0,
                ...
                p = function() {
                    ...
                    wt(I),
                    P.bSort && Ht(I, "aoDrawCallback", function() {
                        if (I.bSorted) {
                            var e = Dt(I)
                              , n = {};
        ...
        n = null,
        this
    }, Gt = {}, $t = /[\r\n]/g, zt = /<.*?>/g, Yt = /^\d{2,4}[\.\/\-]\d{1,2}[\.\/\-]\d{1,2}([T ]{1}\d{1,2}[:\.]\d{2}([\.:]\d{2})?)?$/, Zt = RegExp("(\\/|\\.|\\*|\\+|\\?|\\||\\(|\\)|\\[|\\]|\\{|\\}|\\\\|\\$|\\^|\\-)", "g"), Kt = /[',$Â£â‚¬Â¥%\u2009\u202F\u20BD\u20a9\u20BArfk]/gi, Qt = function(t) {
        return !t || !0 === t || "-" === t
    }, te = function(t) {
        var e = parseInt(t, 10);
    ...
    Xt("draw()", function(t) {
        return this.iterator("table", function(e) {
            "page" === t ? k(e) : ("string" == typeof t && (t = "full-hold" !== t),
            O(e, !1 === t))
        })
    }),
    Xt("page()", function(t) {
    ...
    var De = function(e, n, r, o, i) {
      ...
      , Ce = function(e, n) {
        ...
        if ("current" == o)
            ...
            i = "none" == s ? a.slice() : "applied" == s ? l.slice() : t.map(a, function(e) {
    ...
    Xt("rows()", function(e, n) {
        ...
        var r = this.iterator("table", function(r) {
            ...
            return De("row", e, function(e) {
                ...
                if (n = le(oe(r.aoData, o, "nTr")),
                e.nodeName)
                    return e._DT_RowIndex !== a ? [e._DT_RowIndex] : e._DT_CellIndex ? [e._DT_CellIndex.row] : (n = t(e).closest("*[data-dt-row]")).length ? [n.data("dt-row")] : [];
    ...
    Xt("cells()", function(e, n, r) {
        ...
        null === n || n === a)
            return this.iterator("table", function(n) {
                var o, i, l, s, u, c, f, d = e, h = ye(r), p = n.aoData, g = Ce(n, h), b = le(oe(p, g, "anCells")), S = t([].concat.apply([], b)), m = n.aoColumns.length;
...
!function(e) {
    ...
    o.ext.renderer.pageButton.bootstrap = function(a, s, r, d, i, l) {
        var c, u, p, f = new o.Api(a), b = a.oClasses, m = a.oLanguage.oPaginate, g = a.oLanguage.oAria.paginate || {}, x = 0, w = function(t, n) {
